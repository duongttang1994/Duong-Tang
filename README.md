...
I declared three private integer variables that represents the hour, minute, and second of a 
timespan and included the sstream file so that I can convert the integers to a string to display the
duration.
